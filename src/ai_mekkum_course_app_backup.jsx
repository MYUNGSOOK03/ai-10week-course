  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 text-gray-900 flex">
      ...
      <aside className={`w-64 bg-white border-r-2 border-gray-200 fixed h-screen overflow-y-auto shadow-lg transition-transform z-40 ${
        ...
        <div className="p-4 border-b-2 border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100 sticky top-0 z-10">
          <button
            onClick={onBack}
        ...
        <div className="p-4">
          ...
          <nav className="space-y-2">
            {weeks.map((w) => (
              ...
              >
                <div className="font-semibold text-sm">Week {w.week}</div>
                <div className={`text-xs mt-1 ${
                  weekData.week === w.week ? 'text-blue-100' : 'text-gray-500'
                }`}>
                  {w.title}
                </div>
              </button>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <span className="text-xs font-bold text-indigo-600">주차</span>
                </div>
              </div>
